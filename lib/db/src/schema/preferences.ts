...
export const preferencesTable = pgTable("travel_preferences", {
  ...
  budgetPerNightMin: integer("budget_per_night_min"),
  budgetPerNightMax: integer("budget_per_night_max"),
  budgetFlexibility: text("budget_flexibility").default("moderate"),
